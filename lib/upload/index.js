...
function handle(imageFile) {
    ...
    const allowMimeTypes = config.cos.mimetypes ?
        config.cos.mimetypes : ['image/jpeg', 'image/jp2', 'image/jpm', 'image/jpx', 'image/gif', 'image/bmp', 'image/png', 'audio/mpeg', 'audio/mp3', 'audio/m4a', 'application/pdf']
...
module.exports = (options) => {
    if (options instanceof http.IncomingMessage) {
